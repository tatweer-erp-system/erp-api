...
export async function up({ context: sequelize }: MigrationParams<Sequelize>): Promise<void> {
  ...
  await qi.createTable('employee_contracts', {
    ...
    basicSalary: { type: DataTypes.DECIMAL(15, 2), allowNull: true },
    housingAllowance: { type: DataTypes.DECIMAL(15, 2), allowNull: true },
    transportationAllowance: { type: DataTypes.DECIMAL(15, 2), allowNull: true },
