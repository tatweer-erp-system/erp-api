...
function branchId(tenantIdx: number, branchIdx: number): string {
  if (tenantIdx === 0) return `30000000-0000-4000-a000-00000000000${branchIdx + 1}`;
  const t = (tenantIdx + 1).toString(16).toUpperCase();
  return `3000000${t}-0000-4000-a000-00000000000${branchIdx + 1}`;
}

function deptId(tenantIdx: number, deptIdx: number): string {
  if (tenantIdx === 0) return `50000000-0000-4000-a000-00000000000${deptIdx + 1}`;
  const t = (tenantIdx + 1).toString(16).toUpperCase();
  return `5000000${t}-0000-4000-a000-00000000000${deptIdx + 1}`;
}

// ── Stable Job Position IDs for Demo Company ──────────────────────────────────
const JOB_CEO_ID = '55000000-0000-4000-a000-000000000001';
const JOB_CFO_ID = '55000000-0000-4000-a000-000000000002';
const JOB_SALES_MGR_ID = '55000000-0000-4000-a000-000000000003';
const JOB_ACCOUNTANT_ID = '55000000-0000-4000-a000-000000000004';
const JOB_HR_MGR_ID = '55000000-0000-4000-a000-000000000005';
const JOB_WH_SUPERVISOR_ID = '55000000-0000-4000-a000-000000000006';
const JOB_SW_ENGINEER_ID = '55000000-0000-4000-a000-000000000007';
const JOB_MARKETING_MGR_ID = '55000000-0000-4000-a000-000000000008';
