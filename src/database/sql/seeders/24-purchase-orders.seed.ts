...
const PARTNER_6_ID = '80000000-0000-0000-0000-000000000006'; // Tech Supplies Co
const PARTNER_7_ID = '80000000-0000-0000-0000-000000000007'; // Food Distributors
const PARTNER_8_ID = '80000000-0000-0000-0000-000000000008'; // Office World
const PARTNER_9_ID = '80000000-0000-0000-0000-000000000009'; // Saudi Paper Co

// Products
const PRODUCT_1_ID = '71000000-0000-0000-0000-000000000001'; // Shawarma, 25 SAR (buy at 12)
const PRODUCT_2_ID = '71000000-0000-0000-0000-000000000002'; // Coffee, 15 SAR (buy at 5)
const PRODUCT_3_ID = '71000000-0000-0000-0000-000000000003'; // Laptop, 3999 SAR (buy at 3200)
const PRODUCT_4_ID = '71000000-0000-0000-0000-000000000004'; // Accessories, 89 SAR (buy at 45)
const PRODUCT_6_ID = '71000000-0000-0000-0000-000000000006'; // Specialty Items (buy at 18)

// Purchase Orders
const PO_1_ID = '82000000-0000-0000-0000-000000000001';
const PO_2_ID = '82000000-0000-0000-0000-000000000002';
const PO_3_ID = '82000000-0000-0000-0000-000000000003';
const PO_4_ID = '82000000-0000-0000-0000-000000000004';

// Receipts
const RECEIPT_1_ID = '87000000-0000-0000-0000-000000000001';
const RECEIPT_2_ID = '87000000-0000-0000-0000-000000000002';
