...
import { OutboxSharedService } from './outbox-shared.service';
import { ZatcaXmlSharedService } from './zatca-xml-shared.service';
import { ZatcaSigningSharedService } from './zatca-signing-shared.service';
import { ZatcaQrSharedService } from './zatca-qr-shared.service';
import { ZatcaPortalSharedService } from './zatca-portal-shared.service';
import {
  ZatcaConfig,
  ZatcaInvoiceData,
  ZatcaLineData,
} from '@/modules/zatca/interfaces/zatca.interfaces';
import {
  ZatcaInvoiceType,
...
@Injectable()
export class ZatcaSharedService {
  private readonly logger = new Logger(ZatcaSharedService.name);
  ...
  constructor(
    ...
    private readonly xmlService: ZatcaXmlSharedService,
    private readonly signingService: ZatcaSigningSharedService,
    private readonly qrService: ZatcaQrSharedService,
    private readonly portalService: ZatcaPortalSharedService,
  ) {}
