...
export class StockLevel extends Model {
  ...
  @Column({ type: DataType.DECIMAL(12, 3), allowNull: false, defaultValue: 0 }) quantity!: number;
  @Column({ type: DataType.DECIMAL(12, 3), allowNull: false, defaultValue: 0, field: 'reserved_quantity' }) reservedQuantity!: number;
