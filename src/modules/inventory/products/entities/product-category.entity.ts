...
@Table({ tableName: 'product_categories', timestamps: true, paranoid: true, underscored: true })
export class ProductCategory extends Model {
  ...
  @Column({ type: DataType.UUID, allowNull: true, field: 'parent_id' }) parentId!: string | null;
